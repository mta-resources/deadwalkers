--[[
#---------------------------------------------------------------#
----* DayZ MTA Script gang_client.lua                       *----
...
addEventHandler("onClientResourceStart", resourceRoot, function()
  -- upvalues: gangGUI
  gangGUI.main.window = guiCreateWindow(301, 191, 415, 318, "Sistema de Grupos", false)
  ...
  guiGridListAddColumn(gangGUI.gang_panel.memberList, "Conta:", 0.45)
  guiGridListAddColumn(gangGUI.gang_panel.memberList, "Adicionado por:", 0.45)
  guiGridListSetSortingEnabled(gangGUI.gang_panel.memberList, false)
  gangGUI.gang_panel.invite_player = guiCreateButton(214, 29, 190, 28, "Convidar jogador", false, gangGUI.main.window)
  gangGUI.gang_panel.kick_member = guiCreateButton(214, 68, 190, 28, "Kickar jogador", false, gangGUI.main.window)
  gangGUI.gang_panel.add_subleader = guiCreateButton(214, 107, 190, 28, "Adicionar direitos", false, gangGUI.main.window)
